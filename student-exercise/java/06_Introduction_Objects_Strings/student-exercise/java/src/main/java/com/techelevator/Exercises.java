...
public class Exercises {
	 ...
	 */
	public String firstTwo(String Hello) {
	 ...
	 */
	public String firstHalf(String WooHoo) {
		return WooHoo.substring(0, WooHoo.length() / 2);
	}
	 ...
	 */
	public String withoutEnd(String Hello) {
		return Hello.substring(1, Hello.length() - 1);
	}
	 ...
	 * → "hotlava"
	 */
	public String nonStart(String dog, String cat) {
		return dog.substring(1) + cat.substring(1);
	}
	 ...
	 */
	public String right2(String Hello) {
		return Hello.substring(Hello.length() - 2) + // 4-2 = lo
				Hello.substring(0, Hello.length() - 2); //
	}
	 ...
	 */
	public String middleThree(String Candy) {
		int mid = Candy.length() / 2;
		return Candy.substring(mid - 1, mid + 2);
	}
	...
	public String frontTimes(String str, int n) {
		int soTired = 3;
		if (soTired > str.length()) {
			soTired = str.length();
		}
		String front = str.substring(0, soTired);
