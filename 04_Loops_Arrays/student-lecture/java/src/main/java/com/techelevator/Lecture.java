...
public class Lecture {
	...
	public int returnFirstElementOfParam(int[] passedInArray) {
		System.out.println(passedInArray.length);
	...
	public int returnLastElementOfParam(int[] passedInArray) {
		return passedInArray[passedInArray.length - 1]; // if you're passed an array of unknown size, .length - 1 will
														// always give you the last one.
	}
