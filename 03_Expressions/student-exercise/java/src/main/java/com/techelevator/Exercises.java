...
public class Exercises {
	...
	/*
	 * 16. When squirrel get together for a party, they like to have cigars. A
	 * squirrel party is successful when the number of whores is between 40 and 60,
	...
	public boolean inOrder(int a, int b, int c, boolean bOk) {
		...
		if ((bOk == true && c > b) || (bOk != true && b > a && c > b))
			return true;
